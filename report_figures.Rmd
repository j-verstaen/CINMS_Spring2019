...
percent_map <- ggplot(data = tot_freq_sf) +
  geom_sf(aes(color = tot_freq_sf$station_name) , show.legend = element_blank())+
  #scale_color_brewer(palette= "Oranges")+
  scale_color_manual(values=c("#AD5911","#AD5911","#AD5911","#AD5911","#AD5911","#AD5911","#AD5911","#AD5911","#AD5911"))+
  ...
  geom_sf_label(aes(label = simple_label, color= station_name), size= 5)+
  #something legend = point i did it before and then deleted it :[, i would recognize it if i saw it
  xlab(" ")+
  ylab(" ")+ 
