...
percent_map <- ggplot(data = tot_freq_sf) +
  ...
  geom_sf_label(aes(label = simple_label), fill = col, color= "aliceblue", size= 8)+
  xlab(" ")+
  ylab(" ")+ 
...
detec_fig2$station_name <- factor(detec_fig2$station_name, levels = c("Station 1", "Station 2","Station 3", "Station 5", "Station 6", "Station 7", "Station 8", "Station 9", "Station 10"))


all <-ggplot(detec_fig2) +
  geom_point(aes(x=date_time, y= station_name, color= transmitter), shape=15, size=3) +
  scale_color_manual(values=c("#000033","#003A2F","#01635B","#35918C","#7DC7BD","#D8BB77","#B97D2D","#874E08","#502F06", "#00CC99", "#003000", "#99CCCC"))+
...
ggsave("all.jpg", width=10, height=4, dpi=300)
